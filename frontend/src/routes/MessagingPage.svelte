...
<div class="container px-10 w-[100rem]">
  <div class="max-w-full border rounded">
    <div class="tabs">
      <a class="tab tab-lg tab-bordered tab-active">Conversation</a> 
...
<div class="flex justify-center my-4">
  <div class="mb-3 xl:w-full mx-10">
    <!-- Buttons for text-->
    <div class="block p-6  rounded shadow-lg bg-gray-300 w-full">
    ...
    <textarea
      class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border 
        border-solid border-gray-300 rounded transition ease-in-out focus:text-gray-700 focus:bg-white 
