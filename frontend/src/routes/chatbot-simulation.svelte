  ...
  <div class="mb-3 w-full mx-10">
    ...
    <div class="block py-2 px-4 rounded-t shadow-lg bg-gray-300 w-full">
      ...
      <div class="float-right"> -->
        <button on:click={returnToModules} type="button" class="rounded inline-block px-6 py-2.5 bg-red-600 text-white font-medium text-xs leading-tight uppercase hover:bg-blue-700 focus:bg-blue-700 focus:outline-none focus:ring-0 active:bg-blue-800 transition duration-150 ease-in-out float-right">End Chat</button>
      <!-- </div> -->
    </div>
    <!-- Text area -->
    <textarea
